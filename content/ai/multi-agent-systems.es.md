---
id: concept.multi-agent-systems.es
type: concept
...
related: [ai.llm-agents.es, ai.rag.es]
contributors:
...
# Arquitectura de Sistemas Multi-Agente (MAS)

Los Sistemas Multi-Agente orquestan múltiples agentes autónomos con roles especializados para resolver tareas complejas mediante colaboración.
