---
id: guide.csharp-architecture-guide.en
type: guide
...
related: [language.csharp.en, guide.user-manual.en]
contributors:
...
# C# (.NET) Modern Architecture and Solution Structuring Guide

Clean Architecture and CQRS separation in modern .NET 8/9 solutions.
