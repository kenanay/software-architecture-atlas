---
id: guide.swift-architecture-guide.en
type: guide
...
related: [language.swift.en, guide.user-manual.en]
contributors:
...
# Swift Apple Ecosystem Architecture and SPM Guide

Modularization using Swift Package Manager (SPM) and SwiftUI + TCA in Apple platforms.
