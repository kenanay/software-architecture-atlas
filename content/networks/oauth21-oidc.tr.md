...
# OAuth 2.1 ve OpenID Connect (OIDC) Kimlik Doğrulama Mimarisi

OAuth 2.1; modern web, mobil ve tek sayfalı uygulamalarda (SPA) yetkilendirme standartlarını sadeleştiren, Implicit ve Resource Owner Password Credentials akışlarını kaldırarak PKCE (Proof Key for Code Exchange) zorunluluğu getiren güvenlik standardıdır.
